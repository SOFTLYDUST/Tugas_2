...
// ── Main Component ─────────────────────────────────────────────────────────────
export default function AnggelinaPage() {
  return (
    <div className="relative min-h-screen flex justify-center py-10 overflow-hidden bg-gradient-to-br from-blue-300 via-white to-yellow-200">
      ...
      <div className="w-full max-w-4xl bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 z-10">
        ...
        <div className="h-40 bg-gradient-to-r from-blue-400 via-blue-500 to-yellow-300 relative">
          ...
          <div className="absolute -bottom-14 left-8">
            <img
              src="/img/foto-enjel.jpeg"
              alt="profile"
              className="w-28 h-28 rounded-full border-4 border-white object-cover shadow-md"
            />
          </div>

          {/* LOGOUT - pojok kanan atas cover */}
